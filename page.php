...
<div class="col-sm-12 col-lg-8" id="main" role="main">
    <article class="post Card typo paddingall" itemscope itemtype="http://schema.org/BlogPosting">
        <div class="post-box">
            ...
            <div class="info">
            <ul class="post-meta">
                <li itemprop="author" itemscope itemtype="http://schema.org/Person"><i class="fa fa-user-o" aria-hidden="true">&nbsp; </i><a itemprop="name" href="<?php $this->author->permalink(); ?>" rel="author"><?php $this->author(); ?></a></li>
                <li><i class="fa fa-calendar-o" aria-hidden="true">&nbsp; </i><time datetime="<?php $this->date('c'); ?>" itemprop="datePublished"><?php $this->date(); ?></time></li>
